...
#define FileName @"TimetableItems.archive"

@implementation TimetableCache

@synthesize cachedStartDates;
...
+(void) initialize
{
    NSString *cacheDirectory = [TimetableCache cacheDirectory];
    ...
    double currentAppVersion = [[TimetableCache appVersion] doubleValue];
...
+(void) saveMemoryCacheToDisk:(NSNotification *)notification
{
    ...
    {
        NSString *archivePath = [[TimetableCache cacheDirectory] stringByAppendingPathComponent:filename];  
...
+(void) clearCache
{
    NSArray *cachedItems = [[NSFileManager defaultManager] contentsOfDirectoryAtPath:[TimetableCache cacheDirectory] 
                                                                               error:nil];
...
+(NSString*) cacheDirectory
{
	...
	return [cachesDirectory stringByAppendingPathComponent:@"Timetable"];  
}
