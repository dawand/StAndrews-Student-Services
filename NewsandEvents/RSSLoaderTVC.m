...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"School News";
...
//    if(cachedNews == nil || cachedEvents == nil){
        ...
        rss.delegate = self;
        [rss load:@"school":segmentedControlChoice];
...
- (void) viewDidDisappear:(BOOL)animated{
    ...
    [SchoolNewsCache cacheItems:NewsItems];
    [SchoolEventsCache cacheItems:EventsItems];
}
...
- (IBAction)SegChanged:(id)sender {
    ...
    else
    {
        ...
        self.navigationItem.title = @"School Events";
    }
