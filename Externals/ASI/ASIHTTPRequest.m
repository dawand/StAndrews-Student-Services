...
+ (void)initialize
{
	if (self == [ASIHTTPRequest class]) {
		...
		ASIAuthenticationError = [[NSError alloc] initWithDomain:NetworkRequestErrorDomain code:ASIAuthenticationErrorType userInfo:[NSDictionary dictionaryWithObjectsAndKeys:@"Authentication failed",NSLocalizedDescriptionKey,nil]];
...
- (id)initWithURL:(NSURL *)newURL
{
	...
	[self setShouldPresentCredentialsBeforeChallenge:NO];
	...
	[self setShouldPresentProxyAuthenticationDialog:NO];
